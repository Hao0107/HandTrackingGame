...
public class GameManager : MonoBehaviour
{
    ...
    public bool IsDataDownloaded() {
        return 
        //   File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Level_valea.json")) 
        ...
        // My data
        && File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Level_wildhunt.json"))  
        && File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Themes_wildhunt.json"))
        && File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Config_wildhunt.json"))
        && File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/GeoBuffer_wildhunt.json"));
    ...
    void Start()
    {
        ...
        else 
        {
            ...
            if (totalDownloadsRequired == 0) {
                ...
                // My data to Download
                +ConvertBoolToInt(!File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Level_wildhunt.json")))
                + ConvertBoolToInt(!File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Themes_wildhunt.json")))
                + ConvertBoolToInt(!File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/Config_wildhunt.json")))
                + ConvertBoolToInt(!File.Exists(Path.Combine(Application.persistentDataPath, "LevelData/GeoBuffer_wildhunt.json")));
    ...
    private IEnumerator LoadData()
    {
        ...
        // MY LEVEL 
        if (EnsureFile("LevelData/Config_wildhunt", "LevelData/Config_wildhunt.json")) downloadCount++;
        if (EnsureFile("LevelData/Level_wildhunt", "LevelData/Level_wildhunt.json")) downloadCount++;
        if (EnsureFile("LevelData/Themes_wildhunt", "LevelData/Themes_wildhunt.json")) downloadCount++;
        if (EnsureFile("LevelData/GeoBuffer_wildhunt", "LevelData/GeoBuffer_wildhunt.json")) downloadCount++;
        ...
        if (EnsureBinaryFile("WorldShow/World_wildhunt", "WorldShow/World_wildhunt.png", "png")) downloadCount++;
    ...
    //    string path = Path.Combine(Application.persistentDataPath, "LevelData/Level_wildhunt.json");
